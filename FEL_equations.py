...
def resonant_electron_energy(beam_energy=0,n=0,undulator_period=0,wavelength=0,undulator_parameter=0):
    """
    n=0 beam energy in SI and returns resonant gamma undulator_parameter
    n=1 takes undulator period, seed wavelength and undulator parameter in SI and returns resonant gamma
    """
    if n == 0:
        resonant_gamma  = beam_energy/(const.m_e*const.c*const.c)
        return resonant_gamma
    elif n == 1:
        resonant_gamma = np.sqrt((undulator_period/(2*wavelength))*(1+undulator_parameter*undulator_parameter/2))
        return resonant_gamma
...
def resonant_wavelength(undulator_period, K_factor, resonant_gamma_factor):
    ...
    wavelength = (undulator_period/(2*resonant_gamma_factor*resonant_gamma_factor))*(1+(K_factor*K_factor)/2)
...
#def gain_function(undulator_parameter,total_undulator_periods,undulator_period,electron_density,resonant_gamma,normalized_e_energy):
#    pass
